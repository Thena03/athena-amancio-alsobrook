...
<div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
        <h3 class="text-xl font-semibold text-teal-600">Research Assistant — School of Education & Human Development</h3>
        <p class="text-sm text-slate-500 mb-3">Systematic Review · Mental Health · Technology</p>
        <ul class="list-disc list-inside text-slate-700 space-y-2">
          <li>Conducted systematic literature review on culturally-informed, technology-based mental health services under Dr. Soyeon Ahn</li>
