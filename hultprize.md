...
permalink: /experience/hult-prize
---
<!-- ===== HEADER ===== -->
<section class="py-20">
  <div class="max-w-5xl mx-auto px-6">
    <h1 class="text-4xl font-bold text-teal-900 mb-4">
      <br> University of Miami Hult Prize Campus Director 
    </h1>
...
<section class="py-16">
  ...
  <div>
        <h3 class="text-xl font-semibold text-teal-600 mb-3">As Campus Director, I</h3>
        <ul class="list-disc list-inside text-slate-700 space-y-2">
          ...
          <li>Facilitate student team development from ideation to pitch</li>
          <li>Serve as the primary liaison between the University and the global Hult Prize organization.</li>
        </ul>
      </div>
